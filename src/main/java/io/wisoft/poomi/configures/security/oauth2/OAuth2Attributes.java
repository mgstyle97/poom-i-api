...
public class OAuth2Attributes {
    ...
    @Builder
    public OAuth2Attributes(final Map<String, Object> attributes,
    ...
    public static OAuth2Attributes of(final String registrationId,
    ...
    private static OAuth2Attributes ofGoogle(final String userNameAttributeName,
                                             final Map<String, Object> attributes) {
    ...
    private static OAuth2Attributes ofFacebook(final String userNameAttributeName,
                                               final Map<String, Object> attributes) {
        return OAuth2Attributes.builder()
                .name((String) attributes.get("name"))
                .email((String) attributes.get("email"))
    ...
    private static OAuth2Attributes ofKakao(final String userNameAttributeName,
                                            final Map<String, Object> attributes) {
