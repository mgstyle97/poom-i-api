package io.wisoft.poomi.domain.auth.property.sms;

import io.wisoft.poomi.domain.auth.BaseCertificationEntity;
import io.wisoft.poomi.domain.auth.property.BasePropertyValidationEntity;
...
public class SmsCertification extends BasePropertyValidationEntity {
