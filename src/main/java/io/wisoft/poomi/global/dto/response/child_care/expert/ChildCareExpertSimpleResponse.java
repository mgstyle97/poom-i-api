...
@Getter
@Setter
public class ChildCareExpertSimpleResponse {
    ...
    @Builder
    public ChildCareExpertSimpleResponse(final Long expertId, final Long managerId,
    ...
    public static ChildCareExpertSimpleResponse of(final ChildCareExpert expert) {
        return ChildCareExpertSimpleResponse.builder()
