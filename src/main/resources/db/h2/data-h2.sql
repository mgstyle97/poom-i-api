...
VALUES (1, '35217', '대전 서구 월평중로 50', '월평동 전원아파트 103동 303호', 1),
...
VALUES (1, 'admin', '01012123636', 'admin@poomi.com', '{bcrypt}$2a$10$uUooeQNjjnw3JqLaKqqKoO9sv/ZqkoRAVOcayqWH1tJe7FF4LN5em', 'admin', 'MALE', 25, 1, 'APPROVED', 1),
       (2, '손지연', '01022222222', 'aldusehd@gmail.com', '{bcrypt}$2a$10$uUooeQNjjnw3JqLaKqqKoO9sv/ZqkoRAVOcayqWH1tJe7FF4LN5em', '지연동', 'FEMALE', 23, 2, 'APPROVED', 2),
       ...
       (4, '최창인', '01012121212', 'chain@gmail.com', '{bcrypt}$2a$10$uUooeQNjjnw3JqLaKqqKoO9sv/ZqkoRAVOcayqWH1tJe7FF4LN5em', '최인창', 'MALE', 26, 4, 'APPROVED', 4);
...
VALUES (1, '숲이 조아', '매월 둘째, 넷째 주 토요일 오후 2~5시', '숲 속 체험', '<p>안녕하세요~ 숲이 조아의 대표 지연동입니다<br>저희는 품앗이 이름처럼 자연과 함께 할 수 있는 활동으로 진행하고 있습니다.<br> 자연과 함께 뛰놀 아이와 부모님 함께 해요~</p>',
...
INSERT INTO child_care_group(id, name, regular_meeting_day, main_activity, description, created_at, modified_at, recruitment_status, writer_id, address_tag_id, profile_image_id)
VALUES (2, '우리동네 품앗이', '매월 첫째, 셋째 주 토요일 오후 2~5시', '그림, 놀이', '<p>안녕하세요~ 우리동네 품앗이의 대표 아이정입니다<br>저희는 아이들이 다같이 그림도 그리고 놀 수 있는 활동을 진행하고 있습니다.<br> 그림과 놀이에 관심있는 아이와 부모님 함께 해요~</p>',
...
INSERT INTO child_care_group(id, name, regular_meeting_day, main_activity, description, created_at, modified_at, recruitment_status, writer_id, address_tag_id, profile_image_id)
VALUES (3, '블럭과 함께', '매월 둘째, 넷째 주 토요일 오후 2~5시', '블럭 체험', '<p>안녕하세요~ 블럭과 함께의 대표 지연동입니다<br>저희는 아이들의 창의성을 기를 수 있는 블럭 놀이를 진행하고 있습니다.<br> 블럭을 좋아하고 관심있는 아이와 부모님 함께 해요~</p>',
...
INSERT INTO child_care_group(id, name, regular_meeting_day, main_activity, description, created_at, modified_at, recruitment_status, writer_id, address_tag_id, profile_image_id)
VALUES (4, '문학이 조아요', '매월 첫째, 셋째 주 일요일 오후 1~3시', '<p>독서', '안녕하세요~ 문학이 조아요의 대표 아이정입니다<br>저희는 아이들이 독서에 흥미를 가지고 다양한 책을 읽을 수 있는 활동을 진행하고 있습니다.<br> 아이들의 글읽기에 관심있는 아이와 부모님 함께 해요~</p>',
...
VALUES (1, '<p>오랜만에 야외로 나가보았습니다~ 오랜만에 야외에서의 활동이라 아이들이 너무 좋아해 기분 좋았습니다! 기존에 만들던 천막을 활용해 놀이를 하니 아이들도 뿌듯함을 느낀 것 같더라구요~</p>', now(), now(), 2, 3);

INSERT INTO board_image(board_id, image_id)
VALUES (1, 1);

INSERT INTO group_board(id, contents, created_at, modified_at, group_id, writer_id)
VALUES (2, '<p>이번주 활동은 아이들과 야외에서 뛰어놀며 다양한 활동을 해보았는데요. 오랜만에 바람도 쐬고 아이들이 좋아하는 모습을 보니 기분이 좋더라구요!</p>', now(), now(), 1, 2);

INSERT INTO board_image(board_id, image_id)
VALUES (2, 3);

INSERT INTO group_board(id, contents, created_at, modified_at, group_id, writer_id)
VALUES (3, '<p>한동안 모두가 바빠서 활동을 못했었는데 이렇게 넓은 들판에 놀러갔다오니 기분이 상쾌했습니다!, 다음에는 다른 분들도 꼭 함께했으면 좋겠네요~</p>', now(), now(), 2, 3);
...
VALUES (1, '<p>갑자기 야근이 생겼어요.. 한 9시쯤에야 집에 들어갈 수 있을 것 같은데 혹시 우리 애 봐주실 수 있는 분 계신가요?<br>학원에서 6시에 끝나 돌아옵니다..!</p>', 'RECRUIT', now(), now(), 'RECRUITING', '2021-11-15 17:00:00', '2021-11-15 19:00:00', 2, 5, 1),
       (2, '<p>비가 오네요,, 딸아이 마중 나가려 하는데 ㅁㅁ초등학교 자녀 분 계심 우산 같이 씌워줄게요!<br>도움 필요하신 분들 신청하세요:)</p>', 'VOLUNTEER', now(), now(), 'RECRUITING', '2021-11-15 14:00:00', '2021-11-15 16:00:00', 4, 3, 1),
       (3, '<p>오늘 일찍 퇴근하게 되어서 우리 아이 태권도 끝나는 시간(3시 ~ 4시)에 맞춰서 마중 나가려 합니다.<br> 한마음태권도 다니는 자녀분 있으시면 신청해주세요,,!</p>', 'VOLUNTEER', now(), now(), 'RECRUITING', '2021-11-15 15:00:00', '2021-11-15 16:30:00', 3, 1, 1);
